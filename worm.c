...
enum ResCodes doLevel() {
    ...
    switch(game_state) {
        case WORM_GAME_ONGOING:
            ...
            break;
        case WORM_GAME_QUIT:
            showDialog("Game Quitt", "Bitte Taste druecken");
            break;
        case WORM_CRASH:
            showDialog("Worm Crash", "Bitte Taste druecken");
            break;
        case WORM_OUT_OF_BOUNDS:
            showDialog("Out of Bounds", "Bitte Taste druecken");
            break;
        case WORM_CROSSING:
            showDialog("Worm Crossing", "Bitte Taste druecken");
            break;
        default:
            showDialog("Interner Fehler!", "Bitte Taste druecken");
            res_code = RES_INTERNAL_ERROR;
